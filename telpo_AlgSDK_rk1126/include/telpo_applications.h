...
class Telpo_det:public Telpo_AI_base{
    ...
    private:
        ...
        uint32_t __clip(float val, float min, float max)
        {
        ...
        int process(uint8_t* input, float* anchor, int grid_h, int grid_w, int height, int width, int stride,
                   std::vector<float>& boxes, std::vector<float>& objProbs, std::vector<int>& classId, float threshold,
                   uint32_t zp, float scale);

        int post_process(uint8_t* input0, uint8_t* input1, uint8_t* input2, int model_in_h, int model_in_w, float conf_threshold,
...
//**********************************************************//
class Smoker_det: public Telpo_algsdk::AlgImpl{
    public:
        static Smoker_det* getInstance();
        telpo_ret_t init() final;
        telpo_ret_t process(cv::Mat &img, std::vector<telpo_object_t> &retObjects) final;
        telpo_ret_t exit() final;
    ...
    private:
        Smoker_det(){};
        Telpo_det telp_det;
        static Smoker_det* instance;
        static std::mutex mtx_t;
};


//**********************************************************//
class Caller_det: public Telpo_algsdk::AlgImpl{
    public:
        static Caller_det* getInstance();
        telpo_ret_t init() final;
        telpo_ret_t process(cv::Mat &img, std::vector<telpo_object_t> &retObjects) final;
        telpo_ret_t exit() final;
...
//**********************************************************//
class Ebike_det: public Telpo_algsdk::AlgImpl{
    public:
        static Ebike_det* getInstance();
        telpo_ret_t init() final;
        telpo_ret_t process(cv::Mat &img, std::vector<telpo_object_t> &retObjects) final;
        telpo_ret_t exit() final;
...
//**********************************************************//
class Fire_det: public Telpo_algsdk::AlgImpl{
    public:
        static Fire_det* getInstance();
        telpo_ret_t init() final;
        telpo_ret_t process(cv::Mat &img, std::vector<telpo_object_t> &retObjects) final;
        telpo_ret_t exit() final;
...
//**********************************************************//
class Smog_det: public Telpo_algsdk::AlgImpl{
    public:
        static Smog_det* getInstance();
        telpo_ret_t init() final;
        telpo_ret_t process(cv::Mat &img, std::vector<telpo_object_t> &retObjects) final;
        telpo_ret_t exit() final;
